...
urlpatterns = [
    ...
    # test url 
    path('room1/<int:room_id>/', views.user1room, name='user1room'),  # 사용자 1용 채팅방 페이지 렌더링 (테스트용)
    path('room2/<int:room_id>/', views.user2room, name='user2room'),  # 사용자 2용 채팅방 페이지 렌더링 (테스트용)
